...
def product_manager():
    _run("product-manager")


def interface_developer():
    _run("interface-developer")


def senior_developer():
    _run("senior-developer")
