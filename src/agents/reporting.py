...
def _build_all_agent_lines(results: dict[str, Any], esc: Callable[[str], str]) -> list[str]:
    lines: list[str] = []
    success_count = 0
    fail_count = 0
...
def _build_senior_dev_lines(results: dict[str, Any], esc: Callable[[str], str]) -> list[str]:
    lines: list[str] = []
...
def _build_processed_failed_lines(results: dict[str, Any], esc: Callable[[str], str]) -> list[str]:
    lines: list[str] = []
