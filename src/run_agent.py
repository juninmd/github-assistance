...
from src.agents.registry import AGENT_REGISTRY, create_agent
from src.agents.registry import create_base_deps as _create_base_deps
...
def _create_agent(
    ...
    return create_agent(agent_name, settings, provider, model, pr_ref)
