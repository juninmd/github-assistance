...
class TestMain(unittest.TestCase):
    ...
    def test_main_default(
        self, mock_allowlist, mock_jules_client, mock_github_client, mock_settings, mock_pr_agent
    ):
    ...
    def test_main_with_args(
        ...
        with patch.object(
            sys,
            "argv",
            ["pr-assistant", "owner/repo#123", "--provider", "ollama", "--model", "llama3"],
        ):
            main()
    ...
    @patch("src.main.JulesClient")
    @patch("src.main.RepositoryAllowlist")
    def test_main_with_provider_no_model(
        self, mock_allowlist, mock_jules_client, mock_github_client, mock_settings, mock_pr_agent
    ):
        mock_settings_instance = MagicMock()
        mock_settings_instance.jules_api_key = "test_key"
    ...
    @patch("src.main.JulesClient")
    @patch("src.main.RepositoryAllowlist")
    def test_main_with_provider_openai(
        self, mock_allowlist, mock_jules_client, mock_github_client, mock_settings, mock_pr_agent
    ):
        mock_settings_instance = MagicMock()
        mock_settings_instance.jules_api_key = "test_key"
